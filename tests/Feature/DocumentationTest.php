...
it('documents the simplified exporter configuration', function (): void {
    ...
    expect($readme)->toContain('Observability is enabled by default')
        ...
        ->and($readme)->toContain('AI_OBSERVABILITY_OTLP_ENDPOINT=https://collector.example.com/v1/traces')
        ->and($readme)->toContain('AI_OBSERVABILITY_OTLP_HEADERS="Authorization=Bearer <token>"')
        ->and($readme)->toContain('AI_OBSERVABILITY_OTLP_ENDPOINT=https://collector.tracefast.dev/v1/traces')
